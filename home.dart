...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    // });
    // socket!.on('eventFromServer', (data) {
    //   print('eventFromServer: $data');
    //   if (data is List<dynamic>) {
    //     print('eventFromServer access!');
    ...
    //     }).toList();
    //     print('eventFromServer Formatdata: $formattedData');
                    ...
                    child: Stack(
                      children: [
                        BarChartRace(
                          ...
                          // index: selectedIndex,
                          index: detect(
                              widget.selectedIndex!.toDouble(), rawData2[0]),
...
class FormattedDataText extends StatelessWidget {
  ...
  const FormattedDataText({key, required this.formattedData});
